...
namespace Foam
{
    defineTemplateTypeNameAndDebug(Cloud<fishAgent>, 0);
}

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::fishAgent::move
(
    fishAgentCloud& cloud,
    trackingData& td,
...
bool Foam::fishAgent::hitPatch(fishAgentCloud&, trackingData&)
{
    return false;
}


void Foam::fishAgent::hitProcessorPatch
(
    fishAgentCloud&,
    trackingData& td
)
...
void Foam::fishAgent::hitWallPatch(fishAgentCloud& cloud, trackingData&)
{
...
void Foam::fishAgent::transformProperties(const tensor& T)
{
...
void Foam::fishAgent::transformProperties(const vector& separation)
{
